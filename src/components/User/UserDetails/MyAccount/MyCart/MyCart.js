  ...
  const placeOrder = () => {
    ...
    if (prebook.length) {
      axios
        .post(`${rootAPI}/prebook`, {
          orderGroupId,
          // productDetais: localStorage.getItem("organicFoodPrebook"),
          buyerId: user._id,
          buyerName: user.name,
    ...
    if (seeds.length) {
      axios
        .post(`${rootAPI}/place_order`, {
          orderGroupId,
          // productDetais: localStorage.getItem("organicFoodSeeds"),
          buyerName: user.name,
          buyerEmail: user.email,
          buyerId: user["_id"],
          buyerMobile: user.number,
    ...
    if (crops.length) {
      axios
        .post(`${rootAPI}/place_order`, {
          orderGroupId,
          productDetais: localStorage.getItem("organicFood"),
          buyerName: user.name,
          buyerEmail: user.email,
          buyerId: user._id,
          buyerMobile: user.number,
