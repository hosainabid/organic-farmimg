...
const TableContainer = ({ allSeed }) => {
  //seed deleting function
  ...
  //   table element here
  const tableElement = allSeed.length ? (
    ...
    <p className="text-center my-4">No Seed Available...</p>
  );
  return (
    <div className="">
