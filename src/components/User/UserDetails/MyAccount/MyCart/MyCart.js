...
export default function MyCart() {
  ...
  const placeOrder = async () => {
    if (!Boolean(shippingAddress.trim()) && !Boolean(isShipOriginalAddress)) {
    ...
    if (seeds.length > 0 && crops.length > 0) {
      ...
      const addedOFOrders = JSON.parse(localStorage.getItem("organicFood"));
        ...
        <div className="row">
          ...
          <div className="col-xl-4  col-lg-12">
            <div className="my-4 p-lg-5 p-md-0">
              ...
              <p className="text-center my-4 h5">
                Total: {Boolean(quickDelivary) ? subTotal + 100 : subTotal}
                /tk
              </p>
          ...
          <StripeCheckout stripeKey="pk_test_51Kp4FSIl8Xfw3K0TXt9M2yIikCsZyc6rcQ2QgVYhb9v2tVurMV7Ok4fUDMnlEIJqkrvKUnkH5ObEhADjhR5CmdZK0020fXqYx1" />
              ...
              <div className="my-4 border shadow bg-white rounded-3">
                {Boolean(user.address) ? (
                  <Fragment>
                    <p className="h5 px-2 py-3">
                      Your corrent address is: {user.address}
                    </p>
                    <div className="form-check mx-2">
                      <input
                        ...
                        id="shippingAddress"
                        onChange={(e) =>
                          setIsShipOriginalAddress(e.target.checked)
                        }
                      />
                      <label
                  ...
                  <Fragment>
                    ...
                    <div className="m-2">
                      <label className="h6" htmlFor="shippingAddress">
                        Shipping Address:
                      </label>
                      <textarea
                        id="shippingAddress"
                ...
                {Boolean(Boolean(user.address) && !isShipOriginalAddress) ? (
                  <div className="m-2">
                    <label className="h6" htmlFor="shippingAddress">
                      Shipping Address:
                    </label>
